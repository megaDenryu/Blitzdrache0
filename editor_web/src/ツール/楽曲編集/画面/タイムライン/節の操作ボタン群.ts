...
const ボタンの並び: ReadonlyArray<{ readonly 種類: 節の操作の種類; readonly 記号: string; readonly 説明: string }> = [
    { 種類: '前へ移動', 記号: '←', 説明: '節を1つ前へ移動' },
    { 種類: '前へ挿入', 記号: '⊢', 説明: '同じパターンを前へ挿入' },
    { 種類: '複製', 記号: '⧉', 説明: '複製(繰り返し回数を1増やす)' },
    { 種類: '削除', 記号: '削除', 説明: 'この節を削除(繰り返しが2回以上なら1回ぶん減らす)' },
    { 種類: '後へ挿入', 記号: '⊣', 説明: '同じパターンを後へ挿入' },
    { 種類: '後へ移動', 記号: '→', 説明: '節を1つ後へ移動' },
]

// 節の枠に出す6つの操作の小さなボタンの列。削除・複製・前後挿入・前後移動をすべてここへ集め、
// カード自身はボタンを持たない(判断16の是正、issue #87)。

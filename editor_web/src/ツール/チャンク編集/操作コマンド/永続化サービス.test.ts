...
describe('ワールド永続化の大域世界構造整合テスト', () => {
    ...
    it('保管庫に大域世界構造が既にあるとき、チャンク保存で既存大域構造が上書きされず高さ格子も書かれないこと', async () => {
        ...
        偽.大域構造 = {
            ...
            広域道路: { 制御点列: 既存道路点, 全幅メートル: 12, 細分割数: 100 },
        }
        ...
        状態.広域道路.制御点列.push({ x: 999, y: 999, z: 999 })
        await 永続化.保存する(状態)

        assert.deepStrictEqual(偽.大域構造.広域道路.制御点列, 既存道路点, '保管庫の広域道路が上書きされず保持されること')

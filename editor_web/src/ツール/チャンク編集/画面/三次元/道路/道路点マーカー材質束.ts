...
// 道路点マーカーの3つの状態それぞれの色。テーマごとに差し替えるため、部品の中へ直に書かない。
...
// 道路点マーカーが取りうる見た目の状態。
export type 道路点マーカーの状態 = '通常' | '選択中' | 'つかんでいる'

// 3つの状態ぶんの材質をまとめて持ち、状態から材質を引く役と、テーマ切替で色を差し替える役を担う。
...
export class 道路点マーカー材質束 {
    ...
    public get 材質一覧(): readonly MeshBasicMaterial[] {
        return [this._通常材質, this._選択材質, this._つかんでいる材質]
    }

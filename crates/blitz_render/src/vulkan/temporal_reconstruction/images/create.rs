...
pub(super) fn 時間再構成の画像を確保する(確保係: &GPU資源の確保係<'_>, 形式: vk::Format, 寸法: vk::Extent2D) -> Result<時間再構成の画像, レンダラーエラー> {
...
fn 時間再構成の画像を作る(確保係: &GPU資源の確保係<'_>, 形式: vk::Format, 寸法: vk::Extent2D) -> Result<vk::Image, レンダラーエラー> {
...
fn 画像ビューを作る(確保係: &GPU資源の確保係<'_>, 形式: vk::Format, 画像: vk::Image) -> Result<vk::ImageView, レンダラーエラー> {

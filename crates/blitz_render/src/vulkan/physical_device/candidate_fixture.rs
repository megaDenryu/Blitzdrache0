...
pub(super) fn ブロック圧縮を選べる候補(添字: usize, 機材名: &str, discreteか: bool, 索引対応: bool, ブロック圧縮対応: bool) -> 選定候補 {
    機能を選べる候補(添字, 機材名, discreteか, 索引対応, ブロック圧縮対応, true)
}

pub(super) fn 機能を選べる候補(添字: usize, 機材名: &str, discreteか: bool, 索引対応: bool, ブロック圧縮対応: bool, 立方体配列対応: bool) -> 選定候補 {

...
use crate::vulkan::material_table::{
    image_id::画像ID, material_id::大域材質ID, pack_input::梱包対象材質, stage_reserve::画素段の予約枠, texture_id::テクスチャID,
    texture_spec::テクスチャ指定,
};

use super::fixture::{余裕のある上限, 検査用供給元, 検査用素材, 画像を選んだ材質};

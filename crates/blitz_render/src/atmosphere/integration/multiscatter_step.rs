...
pub(in crate::atmosphere) fn 区間を積む(放射輝度: &mut [f64; 3], 残存率: &mut [f64; 3], 通過率: &mut [f64; 3], 媒体: &大気散乱媒体, 透過率表: &透過率表, 条件: &区間の条件) {
...
pub(in crate::atmosphere) fn 地面の照り返しを足す(放射輝度: &mut [f64; 3], 媒体: &大気散乱媒体, 透過率表: &透過率表, 地表位置: [f64; 3], 太陽: [f64; 3], 通過率: [f64; 3]) {

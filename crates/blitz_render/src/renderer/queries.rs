...
impl レンダラー {
    ...
    pub fn 間接照明の焼き上げ本数の見込みを取得する(&self) -> Option<焼き上げ本数の見込み> {
        self.描画の処理位置の資源.間接照明の焼き上げ本数の見込み()
    }

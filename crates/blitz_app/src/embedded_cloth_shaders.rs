...
const 目標の確定SPIRV: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/cloth_target_update.spv"));
...
const 目標拘束SPIRV: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/cloth_target_constraint.spv"));
const 曲げ拘束SPIRV: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/cloth_bending_constraint.spv"));
...
const 床とカプセルの押し出しSPIRV: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/cloth_collision_push_out.spv"));

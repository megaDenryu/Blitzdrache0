...
pub(crate) mod aerial_farthest_distance;
...
pub(crate) mod xpbd_solver_bench;
...
pub(crate) fn 可視個体の選別の区間を表示する(統計: Option<&フレーム時間統計>) {
    ...
    println!(
        ...
        統計.標本数, 統計.平均ミリ秒, 統計.五十パーセンタイル値ミリ秒, 統計.九十五パーセンタイル値ミリ秒, 統計.九十九パーセンタイル値ミリ秒, 統計.最大ミリ秒
    );
}
...
fn 区間を表示する(名前: &str, 時間一覧: Vec<f64>) {
    ...
    println!(
        ...
        統計.平均ミリ秒, 統計.五十パーセンタイル値ミリ秒, 統計.九十五パーセンタイル値ミリ秒, 統計.九十九パーセンタイル値ミリ秒, 統計.最大ミリ秒
    );
}
...
pub(crate) fn フレーム時間統計を表示する(統計: &フレーム時間統計) {
    ...
    println!("  標本数: {}", 統計.標本数);
    println!("  平均: {:.4} ms", 統計.平均ミリ秒);
    println!("  p50: {:.4} ms", 統計.五十パーセンタイル値ミリ秒);
    println!("  p95: {:.4} ms", 統計.九十五パーセンタイル値ミリ秒);
    println!("  p99: {:.4} ms", 統計.九十九パーセンタイル値ミリ秒);
    println!("  最大: {:.4} ms", 統計.最大ミリ秒);
    println!("  25ms超過: {}回", 統計.二十五ミリ秒超過数);
}

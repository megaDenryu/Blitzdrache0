...
use super::scene_name::{
    キツネの綴り, テクスチャ圧縮の検収世界の接頭辞, ヘルメットの綴り, 両視錐台外の群の検収世界の綴り, 二材質の検収世界の接頭辞, 地形のエディター世界の綴り, 地形の場所巡り世界の綴り, 地形の夜灯り世界の綴り, 地形の目視見本世界の綴り,
    地形の起点世界の綴り, 地形世界の接頭辞, 小物世界の接頭辞, 平面板の綴り, 床を同居させた植生の検収世界の綴り一覧, 影の検収世界の綴り, 材質差し替えの検収世界の綴り, 植生の検収世界の接頭辞, 石の小屋の屋内の小物世界の綴り,
    部品で組んだ一間四方の骨格の並びの小物世界の綴り, 部品で組んだ家の並びの小物世界の綴り, 部品で組んだ木の並びの小物世界の綴り, 間接照明の検収世界の綴り, 集落の小物世界の綴り,
};
...
fn 名前つきの世界を見分ける(綴り: &str) -> Option<世界の種別> {
    let 種別 = match 綴り {
        ...
        地形のエディター世界の綴り => 世界の種別::地形世界(地形世界の種別::エディター),
        ...
        部品で組んだ一間四方の骨格の並びの小物世界の綴り => 世界の種別::小物世界(小物世界の種別::部品で組んだ一間四方の骨格の並び),

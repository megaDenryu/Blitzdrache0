//! point_light_shadow.slangの2エントリ(頂点+画素段)をSPIR-Vへコンパイルする(判断n)。
//! 常時ビルドする。影を落とす灯を1件も持たない世界でもパイプラインは作るためである。
...
const エントリ一覧: [エントリ指定; 2] = [
    エントリ指定 {
        エントリ名: "vertexMain",
        ステージ: "vertex",
        出力ファイル名: "point_light_shadow_vertex.spv",
    },
    エントリ指定 {
        エントリ名: "fragmentMain",
        ステージ: "fragment",
        出力ファイル名: "point_light_shadow_fragment.spv",
    },
];

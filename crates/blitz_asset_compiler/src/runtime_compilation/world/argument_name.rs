...
pub(super) fn 解析する(引数名: &str) -> Result<対象世界, String> {
    match 引数名 {
        ...
        一間四方の骨格を十棟建てた世界 => Ok(骨格の並びの世界(一間四方の骨格の並びの種類::十棟)),
        一間四方の骨格を百棟建てた世界 => Ok(骨格の並びの世界(一間四方の骨格の並びの種類::百棟)),
        二段に積んだ骨格の見本の世界 => Ok(骨格の並びの世界(一間四方の骨格の並びの種類::二段に積んだ骨格の見本)),
        横に二ベイ継いだ骨格の見本の世界 => Ok(骨格の並びの世界(一間四方の骨格の並びの種類::横に二ベイ継いだ骨格の見本)),
        屋根を載せた一間四方の家の見本の世界 => Ok(骨格の並びの世界(一間四方の骨格の並びの種類::屋根を載せた一間四方の家の見本)),
        屋根を載せた二段の家の見本の世界 => Ok(骨格の並びの世界(一間四方の骨格の並びの種類::屋根を載せた二段の家の見本)),
        煙突を付けた一間四方の家の見本の世界 => Ok(骨格の並びの世界(一間四方の骨格の並びの種類::煙突を付けた一間四方の家の見本)),
...
fn 骨格の並びの世界(種類: 一間四方の骨格の並びの種類) -> 対象世界 {

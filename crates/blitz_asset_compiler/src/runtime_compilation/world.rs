...
pub use part_frame_row_declaration::一間四方の骨格の並びの種類;
pub use part_house_row_declaration::家の並びの規模;
pub use target_world::対象世界;
pub use vertex_diagnostic_declaration::診断の原型;

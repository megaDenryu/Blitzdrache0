//! 試験材料のglTF文書JSONの雛形。担当するのはノード列・プリミティブ列・追加メッシュ列の3箇所だけを差し替えられる文書の組み立てである。
...
pub(super) fn 文書jsonを作る(指定: &文書の指定<'_>) -> String {
  ...
  "materials": [ {{ "doubleSided": true, "pbrMetallicRoughness": {{ "baseColorFactor": [0.8, 0.3, 0.2, 1.0], "metallicFactor": 0.5, "roughnessFactor": 0.4 }} }} ],

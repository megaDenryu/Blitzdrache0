...
use super::prop_group_declaration::{原型と置き方の指定一覧を作る, 小物, 輪, 集まり};
...
pub(super) const 庭の小物一覧: &[原型と置き方の宣言] = &[
    小物("terrain_visual_fence_section", "props/fence_section.glb", 輪(40, 14.0, 0.5)),
    小物("terrain_visual_barrel", "props/barrel.glb", 集まり(5, 43.5, 55.5, 1.8)),
    小物("terrain_visual_wooden_crate", "props/wooden_crate.glb", 集まり(5, 56.5, 55.0, 2.0)),
    小物("terrain_visual_boulder", "props/boulder.glb", 集まり(4, 42.5, 45.0, 2.5)),
    小物("terrain_visual_tree_stump", "props/tree_stump.glb", 集まり(4, 57.5, 44.5, 2.2)),
];

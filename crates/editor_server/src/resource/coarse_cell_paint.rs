//! 大升の塗りの型契約。見下ろし図の下書きが一覧で持つ編集資源であり、1つの大升に置いた高さと地表材質の層を表す。
...
/// 大升の塗りとは、列と行で指した1つの大升に置いた高さと地表材質の層の組のことである。
/// 高さと層はどちらも省けるため`Option`で持ち、両方が無い塗りは生成のときその大升を変えない。

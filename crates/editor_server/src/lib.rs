...
pub use resource::{
    ...
    散布の個体, 散布の設定, 散布設定を変更する, 既定の進行の識別子一覧, 曲の節, 材質の筆致, 楽器, 楽曲, 楽曲ID, 編集コマンド,
    読み込んだ大域世界構造の版, 造成筆致, 造成筆致種別, 道路に合わせて切土盛土する, 道路を削除する, 道路を追加する, 道路下を泥へベイクする, 道路対象,
    道路点を削除する, 道路点を挿入する, 道路点を移動する, 道路点を追加する, 音の並び,
};

...
//! 骨格方式は接合点の材料が4つ・規則の材料が3つ・試験が7つあり、家と木の試験を合わせた数より多い。
//!
//! 束の中の分け方は、材料が「何を写したものか」で分かれ、試験が「何を確かめるか」で分かれる。
//! 材料は骨格自身の接合点・取り付く部品の接合点・煙突の接合点・カタログ・候補・1ベイ1段の規則・連なりの規則・
//! 飾りの8つ、試験は据わる位置・連なり・屋根・床・飾り・煙突・ベイ格子との突き合わせの7つである。
//!
//! ベイ格子との突き合わせをここへ置くのは、展開に要るカタログと規則の材料がこの束にあるためである。

#![cfg(test)]

mod bay_grid_agreement_fixture;
mod bay_grid_agreement_tests;

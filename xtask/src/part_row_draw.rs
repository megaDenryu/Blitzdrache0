...
//! (`tally_line`)。読み取りを別々に持つと、文字列の写しが3つに分かれ、1つだけ直した食い違いが起きる。
//!
...
//!
//! 木の並びと骨格を連ねた見本は器を分ける。見るものが違うためである。どちらも件数を変えた対を持たず、
//! 1件の姿を人が判定できる大きさで写すことが目的である。見本のほうは並び1つを焼いて走らせて測る工程だけを
//! `scale_pair`と共有する。

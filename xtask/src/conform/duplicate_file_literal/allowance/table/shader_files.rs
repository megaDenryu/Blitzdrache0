//! シェーダーの文字列のうち、正本を1箇所へ寄せられないものの台帳。ビルドスクリプトの入力と出力の名前、
...
const ホットリロードの一時出力: &str = "文字列は同じだが別のファイルを指す。ビルドスクリプトの出力はOUT_DIRへ焼く成果物、ホットリロードの出力は実行中に一時ディレクトリへ焼く成果物であり、どちらの文字列を変えても他方は壊れない";
...
pub(super) const 一覧: [寄せられない文字列; 9] = [
    寄せられない文字列 {
        文字列: "vertex.spv",
    ...
    寄せられない文字列 {
        文字列: "scene_distant_environment_fragment.spv",
        現れてよい場所一覧: &[焼く側の入口, 取り込む側の入口, ホットリロードの入口],
        寄せられない理由: ホットリロードの一時出力,
    },
    寄せられない文字列 {
    ...
    寄せられない文字列 {
        文字列: "scene_surface_layer_fragment.spv",
        現れてよい場所一覧: &[焼く側の入口, 取り込む側の入口, ホットリロードの入口],
        寄せられない理由: ホットリロードの一時出力,
    },
    寄せられない文字列 {
        文字列: "scene_surface_layer_distant_environment_fragment.spv",
        現れてよい場所一覧: &[焼く側の入口, 取り込む側の入口, ホットリロードの入口],
        寄せられない理由: ホットリロードの一時出力,
    },
    寄せられない文字列 {
        文字列: "scene_distant_environment.slang",
        現れてよい場所一覧: &[焼く側の入口, ホットリロードの入口],
        寄せられない理由: ビルドスクリプトとの契約,
    },
    寄せられない文字列 {
        文字列: "scene_surface_layer.slang",
        現れてよい場所一覧: &[焼く側の入口, ホットリロードの入口],
        寄せられない理由: ビルドスクリプトとの契約,
    },
    寄せられない文字列 {
        文字列: "scene_surface_layer_distant_environment.slang",
        現れてよい場所一覧: &[焼く側の入口, ホットリロードの入口],
        寄せられない理由: ビルドスクリプトとの契約,
    },
];

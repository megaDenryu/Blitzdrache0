//! 光のにじみピラミッドの段の刻み方の正本と、その写しの対応。写しはxtaskの中にある。
//!
...
const 正本: &str = "crates/blitz_render/src/vulkan/bloom_targets.rs";
const 写し: &str = "xtask/src/distant_view/judgment/bloom_footprint.rs";

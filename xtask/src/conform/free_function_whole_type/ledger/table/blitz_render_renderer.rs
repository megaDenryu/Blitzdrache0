...
const 項目一覧: [未是正の自由関数; 20] = [
    ...
    未是正の自由関数::生成する("draw_stage_resources/create/optional_stages/distant_environment.rs", "生成する", "生成要求"),
    未是正の自由関数::生成する("draw_stage_resources/create/optional_stages/sky_stage.rs", "大気のベイク済み画像を生成する", "生成要求"),
    ...
    未是正の自由関数::生成する("scene_draw_resources/work_area/object_entry.rs", "動く個体の位置と向きを書き込む", "描画対象の材料"),

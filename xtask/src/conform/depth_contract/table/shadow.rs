...
pub(super) const 接点一覧: [接点; 7] = [
    ...
    接点 {
        ...
        期待する文字列: "compare_op(vk::CompareOp::LESS_OR_EQUAL)",
    },
    接点 {
        契約: &光源影深度,
        項目: "点光源の標本比較",

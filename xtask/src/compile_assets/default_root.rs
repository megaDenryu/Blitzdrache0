...
use super::{
    地形の世界, 場所巡りの世界, 夜の多光源の世界, 屋内の多光源の世界, 板の世界, 植生の世界, 生成する, 目視見本の世界, 見本の集落の世界
};
...
pub fn 夜の多光源世界を既定で生成する() -> bool {
    生成する(ソースルート(), Path::new(夜の多光源の既定出力ルート), 夜の多光源の世界)
}
...
pub fn 屋内の多光源世界を既定で生成する() -> bool {
    生成する(ソースルート(), Path::new(屋内の多光源の既定出力ルート), 屋内の多光源の世界)
}

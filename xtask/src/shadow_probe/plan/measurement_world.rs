...
//! 同居植生の原型だけが違うため、条件間の差は投入インデックス数だけになる。
...
impl 計測世界 {
    pub(in crate::shadow_probe) fn 世界名(self) -> &'static str {
        match self {
            Self::代表の地形世界 => crate::compile_assets::地形の世界,
            Self::頂点診断の粗い世界 => crate::compile_assets::頂点診断の粗い世界,
            Self::頂点診断の細かい世界 => crate::compile_assets::頂点診断の細かい世界,
        }
    }

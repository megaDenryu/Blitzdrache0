...
pub(super) const 二材質の実行名: 検収の実行名 = 検収の実行名::定数から生成する(二材質のシーンの名前);
pub(super) const 単一材質の実行名: 検収の実行名 = 検収の実行名::定数から生成する(単一材質のシーンの名前);
...
fn シーン名(条件: 条件) -> 検収シーン名 {
    match 条件 {
        条件::二材質 => 検収シーン名::生成する(二材質のシーンの名前),
        条件::単一材質 => 検収シーン名::生成する(単一材質のシーンの名前),
    }
}

...
//! 1条件ぶんの起動と読み戻しは`run`、代表色の採り方は`pixel_check`、合否の規則は`judgment`にある。
...
fn 検収する() -> Result<String, String> {
    ...
    judgment::計数を検査する(&二材質計数, &単一材質計数)?;
    Ok(format!(
        "2材質の代表色は左{:?}・右{:?}、1材質の対照は左右とも{:?}、シーンパス発行数は2材質{}回と1材質{}回、シーン可視数はどちらも{}、可視個体の選別のシーン可視数はどちらも{}、セット別束縛回数は2材質{:?}と1材質{:?}",
        二材質の色.左,
        二材質の色.右,
        単一材質の色.左,
        二材質計数.シーン.発行数,
